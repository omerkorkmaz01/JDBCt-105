...
#-----------------------------------------------------------------------
  ...
  Scenario Outline: User tablosunda phone sorgulama
  ...
  #-----------------------------------------------------------------------
    ...
    #a@a.com
  Scenario Outline: Users tablsoundan email sorgulama
    * Database baglantisi kurulur.
  ...
  Scenario Outline:
    ...
    * Database baglantisi kurulur.
    * "<first_name>", "<last_name>", "<user_name>", "<email>", "<id>", "<role_id>","<password>" girilerek user kaydi olusturulur
    * user tablosundaki "id" ler listte listelenir
    * Olusturulan User'in "<id>" sinin listede oldugu dogrulanir
    * Database baglantisi kapatilir


    Examples:
    |first_name|last_name|user_name|email|id|role_id|password|
